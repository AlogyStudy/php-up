<?php
	...
	/**
	 * 左链接
	 * [ goods left join categroy on goods.cat_id = category.cat_id ] 这一部分当成 C表看.
	 * 
	 * select goods_id, goods_name, goods_number, shop_price, cat_name from C;
	 * 
	 * select goods_id, goods_name, goods_number, shop_price, cat_name from goods left join categroy on goods.cat_id = category.cat_id;
	 * 
	 */
