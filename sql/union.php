<?php
	...
	$sql = 'select user_name, msg_content, msg_time from ecs_feedback where msg_status = 1 union select user_name, content as msg_content, add_time as msg_time from ecs_comment where status = 1';
